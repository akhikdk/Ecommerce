...
function Login() {
  ...
  <div className="w-[100%] h-[100vh] bg-gray-300 flex justify-center items-center">
    <div className="w-[80%] md:w-[50%] lg:w-[30%] h-[80%] bg-white rounded-xl shadow-xl flex flex-col items-center justify-center">
      ...
      <input type="text" placeholder='Email address' className="w-[80%] h-[3rem] border-1 border-gray-400" /> <br />
      <input type="text" placeholder='password' className="w-[80%] h-[3rem] border-1 border-gray-400" /><br />
